  ...
  return (
    <div className="mx-auto max-w-2xl space-y-8 py-4">
      <header className="space-y-1">
        <h1 className="text-2xl font-bold sm:text-3xl">Puanlama kuralları</h1>
      ...
      <Section title="2 · Lig aşaması sıralaması">
        ...
        <pre className="overflow-x-auto rounded-xl border border-white/10 bg-night-900/70 p-4 text-sm text-star-400">
...
function Rule({ points, label, desc }: { points: number; label: string; desc?: string }) {
  return (
    <div className="card flex items-start gap-3 p-3.5">
      <span className="grid h-9 w-11 shrink-0 place-items-center rounded-lg bg-star-500/15 text-sm font-bold tabular-nums text-star-400">
